...
<section className='grid grid-cols-1 lg:grid-cols-2 gpa-x-8 gap-y-10 px-4 pt-10'>
    {/* Image gallery */}
    ...
    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <fieldset aria-label="Choose a size" className="mt-4">
                ...
                {product.sizes.map((size) => (
                    ...
                    className={({ focus }) =>
                        ...
                        'group relative flex items-center justify-center rounded-md border px-4 py-3 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-4'
                        )
                    }
                    >
                    {({ checked, focus }) => (
        ...
        <section>
            <h1 className='text-2xl font-bold py-5 App'>Similer Products</h1>
